    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <Link to="/admin/financial-reports" className="block h-full">
                    <StatCard title="درآمد هفته" value="۳,۴۰۰,۰۰۰ ت" icon={RevenueIcon} color="bg-green-500" />
                </Link>
                <Link to="/admin/users" className="block h-full">
                    <StatCard title="کاربران جدید (۲۴س)" value="+۱۵" icon={UsersIcon} color="bg-amber-500" />
                </Link>
                <Link to="/admin/reports" className="block h-full">
                    <StatCard title="گزارشات جدید" value={newReportsCount.toString()} icon={ReportsIcon} color="bg-indigo-500" />
                </Link>
            </div>
            ...
            <Card>
                ...
                <ul className="space-y-1">
                    <Link to="/admin/users/1" className="block">
                        <li className="flex items-center justify-between p-2 rounded hover:bg-gray-100 dark:hover:bg-navy-gray-light cursor-pointer">
                            <div>
                     ...
                     <Link to="/admin/users/2" className="block">
                        <li className="flex items-center justify-between p-2 rounded hover:bg-gray-100 dark:hover:bg-navy-gray-light cursor-pointer">
                            <div>
