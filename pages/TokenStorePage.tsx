...
import { useUser, useAppSettings, useToast } from '../contexts/ThemeContext';
    ...
    <>
      <div className="min-h-screen bg-off-white dark:bg-navy-gray-dark p-8">
        <header className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200">فروشگاه توکن</h1>
        ...
        <div className="max-w-5xl mx-auto">
            ...
            <section className="mb-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <Card className="text-center border-2 border-transparent hover:border-turquoise transition-all">
                        <h3 className="text-xl font-bold mb-2">بسته برنزی</h3>
                    ...
                    <Card className="text-center relative border-2 border-turquoise shadow-turquoise/20 dark:shadow-turquoise/10">
                        ...
                        <h3 className="text-xl font-bold mb-2">بسته نقره‌ای</h3>
                    ...
                    <Card className="text-center border-2 border-transparent hover:border-turquoise transition-all">
                        <h3 className="text-xl font-bold mb-2">بسته طلایی</h3>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <Card>
                    <h3 className="text-xl font-semibold mb-4">کد تخفیف</h3>
                ...
                <Card>
                    <h3 className="text-xl font-semibold mb-4">کارت هدیه</h3>
                    <div className="flex gap-2">
