...
import { UsersIcon, RevenueIcon, ReportsIcon } from '../../components/icons';
...
const Dashboard: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <Link to="/admin/reports" className="block h-full">
                    <Card className="!p-6 flex items-center gap-4 h-full hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-gray-600 dark:text-gray-400">گزارشات جدید</h3>
                            <p className="text-3xl font-bold">{newReportsCount}</p>
                        </div>
                    </Card>
                </Link>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                <Card>
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-xl font-semibold">رشد کاربران</h3>
                ...
                <Card>
                     <h3 className="text-xl font-semibold mb-4">نمودار درآمد</h3>
                     <ResponsiveContainer width="100%" height={256}>
            ...
            <Card>
                <h3 className="text-xl font-semibold mb-4">آخرین فعالیت‌ها</h3>
                <ul className="space-y-3">
                    <li className="flex items-center justify-between p-2 rounded hover:bg-gray-100 dark:hover:bg-navy-gray-light">
                        <div>
                           <p>کاربر <span className="font-semibold">user@example.com</span> بسته طلایی را خریداری کرد.</p>
                           <p className="text-xs text-gray-500">۵ دقیقه پیش</p>
                        </div>
                        <span className="text-green-600 font-semibold">+۲۰۰,۰۰۰ ت</span>
                    </li>
                     <li className="flex items-center justify-between p-2 rounded hover:bg-gray-100 dark:hover:bg-navy-gray-light">
                        <div>
                           <p><span className="font-semibold">۵ گزارش</span> جدید ثبت شد.</p>
                            <p className="text-xs text-gray-500">۱ ساعت پیش</p>
                        </div>
                         <span className="text-amber-600">نیاز به بررسی</span>
                    </li>
                     <li className="flex items-center justify-between p-2 rounded hover:bg-gray-100 dark:hover:bg-navy-gray-light">
                        <div>
                           <p>کاربر جدید <span className="font-semibold">new@example.com</span> ثبت‌نام کرد.</p>
                           <p className="text-xs text-gray-500">۳ ساعت پیش</p>
                        </div>
                    </li>
                </ul>
            </Card>
