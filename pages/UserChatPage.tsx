...
const UserChatPage: React.FC = () => {
    ...
    return (
        <div className="flex h-screen w-full bg-off-white dark:bg-navy-gray-dark text-gray-800 dark:text-gray-200 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col">
                <header className="flex items-center justify-between p-4 bg-white/70 dark:bg-navy-gray/70 backdrop-blur-lg border-b border-gray-200 dark:border-navy-gray-light">
                    <div className="flex-1 truncate">
                        <h2 className="text-xl font-semibold truncate">{activeConversation?.title || 'گفتگوی جدید'}</h2>
                        {activeConversation && (
            ...
            <Modal isOpen={isReportModalOpen} onClose={() => setIsReportModalOpen(false)} title="گزارش پیام">
                <form onSubmit={handleReportSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-2">دسته بندی گزارش</label>
                        <select
