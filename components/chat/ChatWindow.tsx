...
const TypingIndicator = () => (
    <div className="flex justify-start w-full">
        <div className="bg-white dark:bg-navy-gray p-4 rounded-b-xl rounded-tr-xl shadow-sm flex items-center gap-2">
                        ...
                        <div key={msg.id} className={`flex w-full ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                            {msg.sender === 'user' ? (
                                ...
                                <div className="flex flex-col items-start gap-2 max-w-lg">
                                    <div className="bg-white dark:bg-navy-gray p-4 rounded-b-xl rounded-tr-xl shadow-sm">
                                        <p className="whitespace-pre-wrap">{msg.text}</p>
                                    </div>
